Public Class MainGameLevel
    ...
    Public Property PreviewValueSume As String
    Public Property RealValueSume As Decimal
    Public Property SafeHeaven As Boolean
    ...
    End Function
    Private Function SetSafeHeaven(IsSafeHeaven As Boolean) As Boolean
